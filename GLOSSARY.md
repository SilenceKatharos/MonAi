...
## Anchor migrations (May 2026 Session 4)

HTML navigation anchors (`id="..."` and `href="#..."` references) in `site/*.html`
were migrated from French to English in May 2026 (Session 4). Filenames remain in
French (cf. the "French filenames" note above), only intra-page anchor identifiers
changed. 39 anchors renamed across the 8 HTML pages; 0 orphan, 0 duplicate, 0 broken
cross-page reference (audited).

| Old (FR) | New (EN) | Defined in |
|---|---|---|
| `these` | `thesis` | `index.html` |
| `trois-couches` | `three-layers` | `index.html` |
| `principes` | `principles` | `index.html` |
| `architecture-technique` | `technical-architecture` | `index.html` |
| `gouvernance` | `governance` | `index.html` |
| `identite` | `identity` | `identite-reputation.html` |
| `fiabilite` | `reliability` | `identite-reputation.html` |
| `composantes` | `components` | `identite-reputation.html` |
| `ponderation-universelle` | `universal-weighting` | `identite-reputation.html` (referenced from `securite.html`) |
| `carte` | `identity-card` | `identite-reputation.html` |
| `plainte` | `complaint` | `identite-reputation.html` |
| `pourquoi` | `why` | `simulateur.html`, `audit-blockchains.html` |
| `methodologie` | `methodology` | `simulateur.html` |
| `profils` | `profiles` | `simulateur.html` |
| `resultats` | `results` | `simulateur.html` |
| `etat-art` | `state-of-the-art` | `audit-blockchains.html` |
| `projets` | `projects` | `audit-blockchains.html` |
| `position` | `positioning` | `audit-blockchains.html` |
| `limites` | `limits` | `audit-blockchains.html` |
| `probleme` | `problem` | `honeypots.html` |
| `trois-sources` | `three-sources` | `honeypots.html` |
| `bug-template` | `template-bug` | `honeypots.html` |
| `monnaie` | `currency` | `economie.html` |
| `emission` | `issuance` | `economie.html` |
| `multiplicateur` | `multiplier` | `economie.html` |
| `racc` | `r-acc` | `economie.html` (referenced from `identite-reputation.html`, `gouvernance.html`) |
| `prime-demande` | `demand-bonus` | `economie.html` |
| `sans-frais` | `no-fees` | `economie.html` |
| `dilemme` | `dilemma` | `gouvernance.html` |
| `distinction` | `core-vs-governed-layer` | `gouvernance.html` |
| `comment-vote` | `how-voting-works` | `gouvernance.html` |
| `pourquoi-100M` | `why-100M-agents` | `gouvernance.html` |
| `pondere-R` | `r-weighted-voting` | `gouvernance.html` |
| `garde-fous` | `safeguards` | `gouvernance.html` |
| `avant-100M` | `before-100M` | `gouvernance.html` |
| `cout-attaque` | `attack-cost` | `gouvernance.html` |
| `principe` | `principle` | `securite.html` |
| `attaques` | `attacks` | `securite.html` |
| `couches` | `layers` | `securite.html` |

Anchors that did **not** need renaming (already English or FR/EN identical):
`vision`, `roadmap`, `sponsorship`, `cold-start`, `injection`, `scoring`, `scenarios`,
`calibration`, `code`, `benchmarks`, `non-crypto`, `supply`, `reputation`, `detection`.
SVG-internal ids (`arr`, `three-layers-title`, `honeypot-flow-title`,
`timeline-100M-title`) were out of scope (not navigation anchors).

Convention applied:

- **kebab-case**, lowercase, words separated by hyphens
- Numeric tokens preserved (`100M`)
- Variable identifiers lowercased per URL conventions (`R_acc` → `r-acc`)
